// use-update —— Tauri 端 useUpdate hook + engine 工厂(shadcn registry 源码)。
//
// useUpdate() 从 <UpdateProvider> 的 context 取 engine,薄封装 SDK 的 useUpdateEngine;
// createSwarmHiveEngine() 异步装配 engine(取当前版本 + ensureClientId + tauriAdapter)。
//
// 依赖:@swarm-hive/sdk, @tauri-apps/api, react;registryDependency: @swarmhive/tauri-adapter
